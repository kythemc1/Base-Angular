  ...
  var handleSidebarMenuActiveLink = function (mode, el, $state) {
    ...
    if (mode === 'click' || mode === 'set') {
      ...
      menu.find('li > a').each(function () {
        ...
        if ($state && state) {
          if (state.indexOf("(") > 0) state = state.substr(0, state.indexOf("("));
          if ($state.is(state)) {
            el = $(this);
            return;
          }
    ...
    */
    ...
    $('body').on('click', '.sidebar-toggler', function (e) {
      ...
      if (body.hasClass("page-sidebar-closed")) {
        ...
        //hiện sidebar
        // $('#scroll-sidebar').closest(".slimScrollDiv").removeClass("hidden");
        $('#scroll-sidebar').addClass("scroll");
      } else {
        body.addClass("page-sidebar-closed");
        ...
        //ẩn sidebar
        $('#scroll-sidebar').removeClass("scroll");
      }
